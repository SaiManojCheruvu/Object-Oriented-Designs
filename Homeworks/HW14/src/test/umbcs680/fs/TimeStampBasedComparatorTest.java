...
class TimeStampBasedComparatorTest {
    ...
    public void getChildren_TimeStamp_Based_Comparator_Test(){
        ...
        assertIterableEquals(List.of(aTest, bTest, rmmd), test.getChildren(Comparator.comparing(FSElement::getCreationTime)));
    }
    @Test
    public void getSubDirectories_TimeStamp_Based_Comparator_Test(){
        ...
        Directory test = (Directory) src.getChildren().get(1);
        assertIterableEquals(List.of(main, test), src.getSubDirectories(Comparator.comparing(FSElement::getCreationTime)));
    }
    @Test
    public void getFiles_TimeStamp_Based_Comparator_Test(){
        ...
        File aTest = (File) test.getFiles().get(0);
        File bTest = (File) test.getFiles().get(1);
        assertIterableEquals(List.of(bTest, aTest), test.getFiles(Comparator.comparing((FSElement::getCreationTime), Comparator.reverseOrder())));
    }
