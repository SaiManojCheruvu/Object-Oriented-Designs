...
class MileageComparatorTest {
    ...
    @Test
    public void mileage_Comparator(){
        ...
        assertIterableEquals(List.of(car2, car1, car4, car3), usedCars);
    }
    @Test
    public void mileage_Comparator_Reversed(){
        List<Car> usedCars = new LinkedList<>(List.of(car1, car2, car3, car4));
        Collections.sort(usedCars, Comparator.comparing((Car car)->car.getMileage(), Comparator.reverseOrder()));
        assertIterableEquals(List.of(car3, car4, car1, car2), usedCars);
    }
