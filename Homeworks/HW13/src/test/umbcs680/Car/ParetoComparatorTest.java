...
class ParetoComparatorTest {
    ...
    @Test
    public void Pareto_Comparator_reversed(){
        ...
        Collections.sort(usedCars, Comparator.comparing((Car::getDominationCount), Comparator.reverseOrder()));
    ...
    public void Pareto_Comparator(){
        ...
        assertIterableEquals(List.of(car1, car3, car4, car2), usedCars);
    }
